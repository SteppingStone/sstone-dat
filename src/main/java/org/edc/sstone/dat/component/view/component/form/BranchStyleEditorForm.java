 ...
 */
public class BranchStyleEditorForm<RW extends MenuItemRecordWriter<?>> extends StyleEditorForm<RW> {

    private static final long serialVersionUID = -1062667143646968812L;

    public BranchStyleEditorForm(RW mirw) {
        super("componentEditorPanel.branchStyleTab",mirw);
    }

    @Override
    protected StyleRecordWriter<StyleRecord> getStyleFromComponent() {
        return component.getBranchStyle();
    }

    @Override
    protected void setStyleForComponent(StyleRecordWriter<StyleRecord> style) {
        component.setBranchStyle(style);
    }
